...
from scripts.load.load_date import load_date
from scripts.load.load_time import load_time
...
def main():
	...
	parser.add_argument("step", choices=["extract", "transform", "load", "merge", "all"], help="pipeline step")
